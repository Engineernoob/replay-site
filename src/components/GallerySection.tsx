...
export default function GallerySection() {
  ...
  return (
    ...
    >
      <motion.h2
        style={{ opacity }}
        className="text-center text-5xl md:text-7xl font-orbitron bg-clip-text text-transparent bg-replay-gradient drop-shadow-[0_0_12px_#00F5FF]"
      >
      ...
      {/* Floating holographic grid overlay */}
      <motion.div
